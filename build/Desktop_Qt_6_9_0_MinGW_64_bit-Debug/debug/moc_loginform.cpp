...
void LoginForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginForm::*)(const QString & )>(_a, &LoginForm::loginRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (LoginForm::*)()>(_a, &LoginForm::registerRequested, 1))
            return;
    }
}
...
// SIGNAL 0
void LoginForm::loginRequested(const QString & _t1)
{
